...
UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://")
UPSTREAM_BRANCH = os.getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = os.getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/NakaiStore")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/TestiNakai")
INSTAGRAM = os.getenv("INSTAGRAM", "https://instagram.com/fadhilabdat")
YOUTUBE = os.getenv("YOUTUBE", "https://youtube.com/@")
GITHUB = os.getenv("GITHUB", "https://github.com/")
DONATE = os.getenv("DONATE", "https://t.me//91")
PRIVACY_LINK = os.getenv("PRIVACY_LINK", "https://")
